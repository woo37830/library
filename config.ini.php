...
$config['DATABASE_SERVER']='jwooten37830.com';
$config['DATABASE_USER']='woo';
$config['DATABASE_PASSWORD']='random1';
$config['INDECKS_DATABASE']='indecks';
$config['LOG_TABLE']='logs';
$config['INDECKS_DATABASE_TABLE']='books';
$config['LIBRARY_DATABASE']='library';
$config['LIBRARY_DATABASE_TABLE']='books';
